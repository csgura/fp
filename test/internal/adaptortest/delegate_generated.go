...
// generated by delegate.go:127
type ExtendsArgs struct {
	Extends SimpleIntf
	DoHello func(self ComplexIntf, ctx context.Context, msg string) string
}

func (r *ExtendsArgs) Hello(ctx context.Context, msg string) string {
	return r.HelloImpl(r, ctx, msg)
}

func (r *ExtendsArgs) HelloImpl(self ComplexIntf, ctx context.Context, msg string) string {

	if r.DoHello != nil {
		return r.DoHello(self, ctx, msg)
	}

	return func(s SimpleIntf) string {
