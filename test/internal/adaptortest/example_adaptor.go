...
// generated by adaptor_example.go:483
type SendOver struct {
	Extends Sender
	DoSend  func(self Sender, msg string) (int, error)
}

func (r *SendOver) Send(msg string) (int, error) {
	return r.SendImpl(r, msg)
}

func (r *SendOver) SendImpl(self Sender, msg string) (int, error) {
