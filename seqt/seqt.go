...
func _[T, U, V any, K comparable]() genfp.GenerateMonadTransformer[fp.SeqT[T]] {
	return genfp.GenerateMonadTransformer[fp.SeqT[T]]{
		...
		Transform: []any{
			...
			fp.Seq[T].Add[fp.Phantom[T]],
			fp.Seq[T].Append[fp.Phantom[T]],
			fp.Seq[T].Concat[fp.Phantom[T]],
			fp.Seq[T].Drop[fp.Phantom[T]],
			fp.Seq[T].Exists[fp.Phantom[T]],
			fp.Seq[T].FilterNot[fp.Phantom[T]],
			fp.Seq[T].Find[fp.Phantom[T]],
			fp.Seq[T].ForAll[fp.Phantom[T]],
			fp.Seq[T].Foreach[fp.Phantom[T]],
			fp.Seq[T].Get[fp.Phantom[T]],
			fp.Seq[T].Head[fp.Phantom[T]],
			fp.Seq[T].Tail[fp.Phantom[T]],
			fp.Seq[T].Init[fp.Phantom[T]],
			fp.Seq[T].IsEmpty[fp.Phantom[T]],
			fp.Seq[T].Last[fp.Phantom[T]],
			fp.Seq[T].MakeString[fp.Phantom[T]],
			fp.Seq[T].NonEmpty[fp.Phantom[T]],
			fp.Seq[T].Reverse[fp.Phantom[T]],
			fp.Seq[T].Size[fp.Phantom[T]],
			fp.Seq[T].Take[fp.Phantom[T]],
