...
func MapCompose2[A1 any, A2, R any](m fp.Try[A1], f1 fp.Func1[A1, A2], f2 fp.Func1[A2, R]) fp.Try[R] {
	return Map(m, fp.Compose2(f1, f2))
}

func MapCompose3[A1 any, A2, A3, R any](m fp.Try[A1], f1 fp.Func1[A1, A2], f2 fp.Func1[A2, A3], f3 fp.Func1[A3, R]) fp.Try[R] {
	return Map(m, fp.Compose3(f1, f2, f3))
}

func MapCompose4[A1 any, A2, A3, A4, R any](m fp.Try[A1], f1 fp.Func1[A1, A2], f2 fp.Func1[A2, A3], f3 fp.Func1[A3, A4], f4 fp.Func1[A4, R]) fp.Try[R] {
	return Map(m, fp.Compose4(f1, f2, f3, f4))
}

func MapCompose5[A1 any, A2, A3, A4, A5, R any](m fp.Try[A1], f1 fp.Func1[A1, A2], f2 fp.Func1[A2, A3], f3 fp.Func1[A3, A4], f4 fp.Func1[A4, A5], f5 fp.Func1[A5, R]) fp.Try[R] {
	return Map(m, fp.Compose5(f1, f2, f3, f4, f5))
}

func FlatMapCompose2[A1 any, A2, R any](m fp.Try[A1], f1 fp.Func1[A1, fp.Try[A2]], f2 fp.Func1[A2, fp.Try[R]]) fp.Try[R] {
	return FlatMap(m, Compose2(f1, f2))
}

func FlatMapCompose3[A1 any, A2, A3, R any](m fp.Try[A1], f1 fp.Func1[A1, fp.Try[A2]], f2 fp.Func1[A2, fp.Try[A3]], f3 fp.Func1[A3, fp.Try[R]]) fp.Try[R] {
	return FlatMap(m, Compose3(f1, f2, f3))
}

func FlatMapCompose4[A1 any, A2, A3, A4, R any](m fp.Try[A1], f1 fp.Func1[A1, fp.Try[A2]], f2 fp.Func1[A2, fp.Try[A3]], f3 fp.Func1[A3, fp.Try[A4]], f4 fp.Func1[A4, fp.Try[R]]) fp.Try[R] {
	return FlatMap(m, Compose4(f1, f2, f3, f4))
}

func FlatMapCompose5[A1 any, A2, A3, A4, A5, R any](m fp.Try[A1], f1 fp.Func1[A1, fp.Try[A2]], f2 fp.Func1[A2, fp.Try[A3]], f3 fp.Func1[A3, fp.Try[A4]], f4 fp.Func1[A4, fp.Try[A5]], f5 fp.Func1[A5, fp.Try[R]]) fp.Try[R] {
