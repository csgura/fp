...
func (r ApplicativeFunctor2[H, HT, A, B, R]) FlatMap(a func(HT) fp.Option[A]) ApplicativeFunctor1[hlist.Repr[A, H], A, B, R] {
...
func (r ApplicativeFunctor2[H, HT, A, B, R]) Map(a func(HT) A) ApplicativeFunctor1[hlist.Repr[A, H], A, B, R] {
	return r.FlatMap(func(h HT) fp.Option[A] {
		return Some(a(h))
	})
}

func (r ApplicativeFunctor2[H, HT, A, B, R]) HListMap(a func(H) A) ApplicativeFunctor1[hlist.Repr[A, H], A, B, R] {
	return r.HListFlatMap(func(h H) fp.Option[A] {
		return Some(a(h))
	})
}

func (r ApplicativeFunctor2[H, HT, A, B, R]) HListFlatMap(a func(H) fp.Option[A]) ApplicativeFunctor1[hlist.Repr[A, H], A, B, R] {
	av := FlatMap(r.h, func(v H) fp.Option[A] {
		return a(v)
	})
...
func (r ApplicativeFunctor2[H, HT, A, B, R]) ApOption(a fp.Option[A]) ApplicativeFunctor1[hlist.Repr[A, H], A, B, R] {
	nh := FlatMap(r.h, func(hv H) fp.Option[hlist.Repr[A, H]] {
		return Map(a, func(av A) hlist.Repr[A, H] {
			return hlist.Concact(av, hv)
		})
	})

	return ApplicativeFunctor1[hlist.Repr[A, H], A, B, R]{nh, Ap(r.fn, a)}
}

func (r ApplicativeFunctor2[H, HT, A, B, R]) Ap(a A) ApplicativeFunctor1[hlist.Repr[A, H], A, B, R] {
	return r.ApOption(Some(a))
}
...
func (r ApplicativeFunctor3[H, HT, A, B, C, R]) ApOption(a fp.Option[A]) ApplicativeFunctor2[hlist.Repr[A, H], A, B, C, R] {
	...
	return ApplicativeFunctor2[hlist.Repr[A, H], A, B, C, R]{nh, Ap(r.fn, a)}
}

func (r ApplicativeFunctor3[H, HT, A, B, C, R]) Ap(a A) ApplicativeFunctor2[hlist.Repr[A, H], A, B, C, R] {
	return r.ApOption(Some(a))
}

func (r ApplicativeFunctor3[H, HT, A, B, C, R]) FlatMap(a func(HT) fp.Option[A]) ApplicativeFunctor2[hlist.Repr[A, H], A, B, C, R] {
...
func (r ApplicativeFunctor3[H, HT, A, B, C, R]) Map(a func(HT) A) ApplicativeFunctor2[hlist.Repr[A, H], A, B, C, R] {
	return r.FlatMap(func(h HT) fp.Option[A] {
		return Some(a(h))
	})
}

func (r ApplicativeFunctor3[H, HT, A, B, C, R]) HListMap(a func(H) A) ApplicativeFunctor2[hlist.Repr[A, H], A, B, C, R] {
	return r.HListFlatMap(func(h H) fp.Option[A] {
		return Some(a(h))
	})
}

func (r ApplicativeFunctor3[H, HT, A, B, C, R]) HListFlatMap(a func(H) fp.Option[A]) ApplicativeFunctor2[hlist.Repr[A, H], A, B, C, R] {
	av := FlatMap(r.h, func(v H) fp.Option[A] {
		return a(v)
	})
