...
func Flatten[A any](tta fp.Option[fp.Option[A]]) fp.Option[A] {
	return FlatMap(tta, func(v fp.Option[A]) fp.Option[A] {
		return v
	})
}

func Map[A any, R any](m fp.Option[A], f func(A) R) fp.Option[R] {
	return FlatMap(m, fp.Compose2(f, Pure[R]))
}

// haskell 의 <$
// map . const 와 같은 함수
func Replace[A any, R any](s fp.Option[A], b R) fp.Option[R] {
	return Map(s, fp.Const[A](b))
}

// Replace fp.Unit{}
func Void[A any](s fp.Option[A]) fp.Option[fp.Unit] {
	return Replace(s, fp.Unit{})
}

func Map2[A any, B, R any](first fp.Option[A], second fp.Option[B], fab func(A, B) R) fp.Option[R] {
	return FlatMap(first, func(a A) fp.Option[R] {
...
func Zip[A any, B any](first fp.Option[A], second fp.Option[B]) fp.Option[fp.Tuple2[A, B]] {
	return Map2(first, second, product.Tuple2)
}

func Ap[A any, B any](tfab fp.Option[fp.Func1[A, B]], ta fp.Option[A]) fp.Option[B] {
	return FlatMap(tfab, func(fab fp.Func1[A, B]) fp.Option[B] {
		return Map(ta, fab)
	})
}

func Compose[A any, B, C any](f1 func(A) fp.Option[B], f2 func(B) fp.Option[C]) func(A) fp.Option[C] {
	return func(a A) fp.Option[C] {
		return FlatMap(f1(a), f2)
	}
}

func Compose2[A any, B, C any](f1 func(A) fp.Option[B], f2 func(B) fp.Option[C]) func(A) fp.Option[C] {
	return func(a A) fp.Option[C] {
		return FlatMap(f1(a), f2)
	}
}

func ApFunc[A any, B any](tfab fp.Option[fp.Func1[A, B]], ta func() fp.Option[A]) fp.Option[B] {
	return FlatMap(tfab, func(fab fp.Func1[A, B]) fp.Option[B] {
		return Map(ta(), fab)
	})
}
...
func Lift[A any, R any](fa func(v A) R) func(fp.Option[A]) fp.Option[R] {
	return func(ta fp.Option[A]) fp.Option[R] {
		return Map(ta, fa)
	}
}

func LiftA2[A any, B, R any](fab func(A, B) R) func(fp.Option[A], fp.Option[B]) fp.Option[R] {
	return func(a fp.Option[A], b fp.Option[B]) fp.Option[R] {
		return Map2(a, b, fab)
	}
}

func LiftM[A any, R any](fa func(v A) fp.Option[R]) func(fp.Option[A]) fp.Option[R] {
	return func(ta fp.Option[A]) fp.Option[R] {
...
// LiftM2 를 다음과 같이 정의함.
func LiftM2[A any, B, R any](fab func(A, B) fp.Option[R]) func(fp.Option[A], fp.Option[B]) fp.Option[R] {
	return func(a fp.Option[A], b fp.Option[B]) fp.Option[R] {
		return Flatten(Map2(a, b, fab))
	}
}

func FlatMap2[A any, B, R any](first fp.Option[A], second fp.Option[B], fab func(A, B) fp.Option[R]) fp.Option[R] {
...
func Flap[A any, R any](tfa fp.Option[fp.Func1[A, R]]) func(A) fp.Option[R] {
...
// 하스켈 : m( a -> b -> r ) -> a -> b -> m r
func Flap2[A any, B, R any](tfab fp.Option[fp.Func1[A, fp.Func1[B, R]]]) fp.Func1[A, fp.Func1[B, fp.Option[R]]] {
...
func FlapMap[A any, B, R any](tfab func(A, B) R, a fp.Option[A]) func(B) fp.Option[R] {
...
// om , ==<<  이름으로 정의된 것이 있음
func FlatFlapMap[A any, B, R any](fab func(A, B) fp.Option[R], ta fp.Option[A]) func(B) fp.Option[R] {
...
func Method1[A any, B, R any](ta fp.Option[A], fab func(a A, b B) R) func(B) fp.Option[R] {
	return FlapMap(fab, ta)
}

func FlatMethod1[A any, B, R any](ta fp.Option[A], fab func(a A, b B) fp.Option[R]) func(B) fp.Option[R] {
	return FlatFlapMap(fab, ta)
}

func Method2[A any, B, C, R any](ta fp.Option[A], fabc func(a A, b B, c C) R) func(B, C) fp.Option[R] {
...
func FlatMethod2[A any, B, C, R any](ta fp.Option[A], fabc func(a A, b B, c C) fp.Option[R]) func(B, C) fp.Option[R] {
...
func UnZip[A any, B any](t fp.Option[fp.Tuple2[A, B]]) (fp.Option[A], fp.Option[B]) {
	return Map(t, xtr.Head), Map(t, xtr.Tail)
}

func Zip3[A any, B, C any](ta fp.Option[A], tb fp.Option[B], tc fp.Option[C]) fp.Option[fp.Tuple3[A, B, C]] {
...
// 형태로 코딩 가능
func With[A any, B any](withf func(A, B) A, v fp.Option[B]) func(A) fp.Option[A] {
	return Flap(Map(v, fp.Flip2(withf)))
}

func LiftA3[A1 any, A2, A3, R any](f func(a1 A1, a2 A2, a3 A3) R) func(fp.Option[A1], fp.Option[A2], fp.Option[A3]) fp.Option[R] {
...
func LiftA5[A1 any, A2, A3, A4, A5, R any](f func(a1 A1, a2 A2, a3 A3, a4 A4, a5 A5) R) func(fp.Option[A1], fp.Option[A2], fp.Option[A3], fp.Option[A4], fp.Option[A5]) fp.Option[R] {
...
func LiftA7[A1 any, A2, A3, A4, A5, A6, A7, R any](f func(a1 A1, a2 A2, a3 A3, a4 A4, a5 A5, a6 A6, a7 A7) R) func(fp.Option[A1], fp.Option[A2], fp.Option[A3], fp.Option[A4], fp.Option[A5], fp.Option[A6], fp.Option[A7]) fp.Option[R] {
...
func LiftA9[A1 any, A2, A3, A4, A5, A6, A7, A8, A9, R any](f func(a1 A1, a2 A2, a3 A3, a4 A4, a5 A5, a6 A6, a7 A7, a8 A8, a9 A9) R) func(fp.Option[A1], fp.Option[A2], fp.Option[A3], fp.Option[A4], fp.Option[A5], fp.Option[A6], fp.Option[A7], fp.Option[A8], fp.Option[A9]) fp.Option[R] {
...
func FlatMethod9[A1 any, A2, A3, A4, A5, A6, A7, A8, A9, R any](ta1 fp.Option[A1], fa1 func(a1 A1, a2 A2, a3 A3, a4 A4, a5 A5, a6 A6, a7 A7, a8 A8, a9 A9) fp.Option[R]) func(A2, A3, A4, A5, A6, A7, A8, A9) fp.Option[R] {
	return func(a2 A2, a3 A3, a4 A4, a5 A5, a6 A6, a7 A7, a8 A8, a9 A9) fp.Option[R] {
		return FlatMap(ta1, func(a1 A1) fp.Option[R] {
			return fa1(a1, a2, a3, a4, a5, a6, a7, a8, a9)
		})
...
func Compose3[A1 any, A2, A3, R any](f1 fp.Func1[A1, fp.Option[A2]], f2 fp.Func1[A2, fp.Option[A3]], f3 fp.Func1[A3, fp.Option[R]]) fp.Func1[A1, fp.Option[R]] {
	return Compose2(f1, Compose2(f2, f3))
}

func Compose4[A1 any, A2, A3, A4, R any](f1 fp.Func1[A1, fp.Option[A2]], f2 fp.Func1[A2, fp.Option[A3]], f3 fp.Func1[A3, fp.Option[A4]], f4 fp.Func1[A4, fp.Option[R]]) fp.Func1[A1, fp.Option[R]] {
	return Compose2(f1, Compose3(f2, f3, f4))
}

func Compose5[A1 any, A2, A3, A4, A5, R any](f1 fp.Func1[A1, fp.Option[A2]], f2 fp.Func1[A2, fp.Option[A3]], f3 fp.Func1[A3, fp.Option[A4]], f4 fp.Func1[A4, fp.Option[A5]], f5 fp.Func1[A5, fp.Option[R]]) fp.Func1[A1, fp.Option[R]] {
	return Compose2(f1, Compose4(f2, f3, f4, f5))
}

func MapCompose2[A1 any, A2, R any](m fp.Option[A1], f1 fp.Func1[A1, A2], f2 fp.Func1[A2, R]) fp.Option[R] {
	return Map(m, fp.Compose2(f1, f2))
}

func MapCompose3[A1 any, A2, A3, R any](m fp.Option[A1], f1 fp.Func1[A1, A2], f2 fp.Func1[A2, A3], f3 fp.Func1[A3, R]) fp.Option[R] {
	return Map(m, fp.Compose3(f1, f2, f3))
}

func MapCompose4[A1 any, A2, A3, A4, R any](m fp.Option[A1], f1 fp.Func1[A1, A2], f2 fp.Func1[A2, A3], f3 fp.Func1[A3, A4], f4 fp.Func1[A4, R]) fp.Option[R] {
	return Map(m, fp.Compose4(f1, f2, f3, f4))
}

func MapCompose5[A1 any, A2, A3, A4, A5, R any](m fp.Option[A1], f1 fp.Func1[A1, A2], f2 fp.Func1[A2, A3], f3 fp.Func1[A3, A4], f4 fp.Func1[A4, A5], f5 fp.Func1[A5, R]) fp.Option[R] {
	return Map(m, fp.Compose5(f1, f2, f3, f4, f5))
}

func FlatMapCompose2[A1 any, A2, R any](m fp.Option[A1], f1 fp.Func1[A1, fp.Option[A2]], f2 fp.Func1[A2, fp.Option[R]]) fp.Option[R] {
	return FlatMap(m, Compose2(f1, f2))
}

func FlatMapCompose3[A1 any, A2, A3, R any](m fp.Option[A1], f1 fp.Func1[A1, fp.Option[A2]], f2 fp.Func1[A2, fp.Option[A3]], f3 fp.Func1[A3, fp.Option[R]]) fp.Option[R] {
	return FlatMap(m, Compose3(f1, f2, f3))
}

func FlatMapCompose4[A1 any, A2, A3, A4, R any](m fp.Option[A1], f1 fp.Func1[A1, fp.Option[A2]], f2 fp.Func1[A2, fp.Option[A3]], f3 fp.Func1[A3, fp.Option[A4]], f4 fp.Func1[A4, fp.Option[R]]) fp.Option[R] {
	return FlatMap(m, Compose4(f1, f2, f3, f4))
}

func FlatMapCompose5[A1 any, A2, A3, A4, A5, R any](m fp.Option[A1], f1 fp.Func1[A1, fp.Option[A2]], f2 fp.Func1[A2, fp.Option[A3]], f3 fp.Func1[A3, fp.Option[A4]], f4 fp.Func1[A4, fp.Option[A5]], f5 fp.Func1[A5, fp.Option[R]]) fp.Option[R] {
